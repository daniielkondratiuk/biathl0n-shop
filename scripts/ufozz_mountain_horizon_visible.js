...
const inboxRoot = "/srv/ufozz-inbox/biathl0n/Mountain Horizon";
const detailRoot = path.join(inboxRoot, "detail");
const publicRoot = "/var/www/biathl0n-shop/public/uploads/products";
const title = "Mountain Horizon";
const designSlug = "mountain-horizon";
...
const enDescription = `A minimalist embroidery concept that combines a sharp mountain silhouette with bold, block typography. The white-on-blue contrast highlights the natural setting of the winter discipline. The design is stripped of unnecessary details, focusing instead on the environment and the name of the sport, suitable for clean and professional athletic apparel.`;
const frDescription = `Un concept de broderie minimaliste qui associe une silhouette de montagne nette à une typographie forte et massive. Le contraste blanc sur bleu met en valeur l’environnement naturel de cette discipline hivernale. Le design élimine les détails superflus pour se concentrer sur le décor et le nom du sport, avec un rendu propre et professionnel adapté aux vêtements athlétiques.`;
