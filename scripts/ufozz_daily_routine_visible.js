...
const inboxRoot = "/srv/ufozz-inbox/biathl0n/Daily Routine";
...
const designSlug = "daily-routine";
...
const enDescription = `This typography-focused design features a bold, slanted sans-serif font in a clean list format. The white-on-black embroidery uses a high-contrast color scheme for maximum readability. By utilizing a popular cultural slogan template, the design makes a straightforward and provocative statement about lifestyle priorities. The minimalist approach strips away all graphic elements, leaving the text as the sole focal point to convey a singular, dedicated mindset.`;
const frDescription = `Ce design centré sur la typographie utilise une police sans sérif inclinée et affirmée, organisée sous forme de liste claire. La broderie blanc sur noir crée un contraste fort pour une lisibilité maximale. En reprenant le principe d’un slogan culturel populaire, le visuel formule une déclaration directe et provocante sur les priorités de vie. Son approche minimaliste élimine tout élément graphique pour laisser le texte comme unique point focal, porteur d’un état d’esprit déterminé et exclusif.`;
